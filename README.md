...
![action](https://img.shields.io/github/actions/workflow/status/diotoborg/rerum-excepturi-nostrum/cd.yml)![npm](https://img.shields.io/npm/dw/@diotoborg/rerum-excepturi-nostrum)[![Coverage Status](https://coveralls.io/repos/github/diotoborg/rerum-excepturi-nostrum/badge.svg?branch=master)](https://coveralls.io/github/diotoborg/rerum-excepturi-nostrum?branch=master)![release](https://img.shields.io/librariesio/release/npm/@diotoborg/rerum-excepturi-nostrum)![npm](https://img.shields.io/npm/v/@diotoborg/rerum-excepturi-nostrum)![sourcerank](https://img.shields.io/librariesio/sourcerank/npm/@diotoborg/rerum-excepturi-nostrum)![NPM](https://img.shields.io/npm/l/@diotoborg/rerum-excepturi-nostrum)[![Code Climate](https://codeclimate.com/github/diotoborg/rerum-excepturi-nostrum/badges/gpa.svg)](https://codeclimate.com/github/diotoborg/rerum-excepturi-nostrum)[![Test Coverage](https://codeclimate.com/github/diotoborg/rerum-excepturi-nostrum/badges/coverage.svg)](https://codeclimate.com/github/diotoborg/rerum-excepturi-nostrum/coverage)[![codecov](https://codecov.io/gh/diotoborg/rerum-excepturi-nostrum/graph/badge.svg?token=0VLDX7ON0N)](https://codecov.io/gh/diotoborg/rerum-excepturi-nostrum)[![docs](https://img.shields.io/badge/docs-info-blue)](https://linyisonger.github.io/3r.Tool/)

#### 如何使用工具包 ?

👇Vue 小栗子 🐿

1.在工程下执行命令`npm i @diotoborg/rerum-excepturi-nostrum`安装依赖包

2.引用对应的工具类`import { Maths } from "@diotoborg/rerum-excepturi-nostrum";`
...
<script>
import { Maths } from "@diotoborg/rerum-excepturi-nostrum";
export default {
  data() {
    return {
      sum: 0,
...
2.引用对应的工具类`import { Maths } from "https://gcore.jsdelivr.net/npm/@diotoborg/rerum-excepturi-nostrum@0.0.14/index.js"`注意版本
...
<html lang="en">
  ...
  <body>
    <script type="module">
      import { Maths } from "https://gcore.jsdelivr.net/npm/@diotoborg/rerum-excepturi-nostrum@0.0.14/index.js";
...
https://github.com/diotoborg/rerum-excepturi-nostrum/issues/new
